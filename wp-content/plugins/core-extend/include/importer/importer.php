    ...
    if ( current_user_can( 'manage_options' ) ) {
        ...
        if ( class_exists( 'WP_Importer' ) && class_exists( 'WP_Import' ) ) {
			...
			switch($demo_type) {
				case 'bienne':
					// Demo data
					$theme_xml_file = MNKY_PLUGIN_PATH . 'include/importer/bienne_demo/theme_data.xml';
					
					// Theme options
					$theme_options_file = MNKY_PLUGIN_PATH . 'include/importer/bienne_demo/theme_options.txt';

					// Widget data
					$widgets_file = MNKY_PLUGIN_PATH . 'include/importer/bienne_demo/widget_data.wie';
				...
				case 'lausanne':
					// Demo data
					$theme_xml_file = MNKY_PLUGIN_PATH . 'include/importer/lausanne_demo/theme_data.xml';
					
					// Theme options
					$theme_options_file = MNKY_PLUGIN_PATH . 'include/importer/lausanne_demo/theme_options.txt';

					// Widget data
					$widgets_file = MNKY_PLUGIN_PATH . 'include/importer/lausanne_demo/widget_data.wie';
				...
				case 'sion':
					// Demo data
					$theme_xml_file = MNKY_PLUGIN_PATH . 'include/importer/sion_demo/theme_data.xml';
					
					// Theme options
					$theme_options_file = MNKY_PLUGIN_PATH . 'include/importer/sion_demo/theme_options.txt';

					// Widget data
					$widgets_file = MNKY_PLUGIN_PATH . 'include/importer/sion_demo/widget_data.wie';
				...
				case 'lugano':
					// Demo data
					$theme_xml_file = MNKY_PLUGIN_PATH . 'include/importer/lugano_demo/theme_data.xml';
					
					// Theme options
					$theme_options_file = MNKY_PLUGIN_PATH . 'include/importer/lugano_demo/theme_options.txt';

					// Widget data
					$widgets_file = MNKY_PLUGIN_PATH . 'include/importer/lugano_demo/widget_data.wie';
				...
				case 'basel':
					// Demo data
					$theme_xml_file = MNKY_PLUGIN_PATH . 'include/importer/basel_demo/theme_data.xml';
					
					// Theme options
					$theme_options_file = MNKY_PLUGIN_PATH . 'include/importer/basel_demo/theme_options.txt';

					// Widget data
					$widgets_file = MNKY_PLUGIN_PATH . 'include/importer/basel_demo/widget_data.wie';
				...
				case 'geneva':
					// Demo data
					$theme_xml_file = MNKY_PLUGIN_PATH . 'include/importer/geneva_demo/theme_data.xml';
					
					// Theme options
					$theme_options_file = MNKY_PLUGIN_PATH . 'include/importer/geneva_demo/theme_options.txt';

					// Widget data
					$widgets_file = MNKY_PLUGIN_PATH . 'include/importer/geneva_demo/widget_data.wie';
				...
				case 'zurich':
					// Demo data
					$theme_xml_file = MNKY_PLUGIN_PATH . 'include/importer/zurich_demo/theme_data.xml';
					
					// Theme options
					$theme_options_file = MNKY_PLUGIN_PATH . 'include/importer/zurich_demo/theme_options.txt';

					// Widget data
					$widgets_file = MNKY_PLUGIN_PATH . 'include/importer/zurich_demo/widget_data.wie';
            ...
            $posts_page = get_page_by_title( 'Company Blog' );
