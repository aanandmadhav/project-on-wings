          ...
          array(
            ...
            'pages'               => array( 
              array(
                ...
                'page_title'      => apply_filters( 'ot_theme_options_page_title', esc_html__( 'Theme Options', 'fintech-wp' ) ),
                'menu_title'      => apply_filters( 'ot_theme_options_menu_title', esc_html__( 'Theme Options', 'fintech-wp' ) ),
                ...
                'updated_message' => apply_filters( 'ot_theme_options_updated_message', esc_html__( 'Theme Options updated.', 'fintech-wp' ) ),
                'reset_message'   => apply_filters( 'ot_theme_options_reset_message', esc_html__( 'Theme Options reset.', 'fintech-wp' ) ),
                'button_text'     => apply_filters( 'ot_theme_options_button_text', esc_html__( 'Save Changes', 'fintech-wp' ) ),
  ...
  function ot_register_settings_page() {
    ...
    if ( OT_SHOW_OPTIONS_UI == true && isset( $_REQUEST['page'] ) && $_REQUEST['page'] == 'ot-settings' && ( $ot_has_custom_theme_options == true || has_action( 'admin_init', 'custom_theme_options' ) || has_action( 'init', 'custom_theme_options' ) ) ) {
      ...
      function ot_has_custom_theme_options() {
        ...
        echo '<div class="error"><p>' . esc_html__( 'The Theme Options UI Builder is being overridden by a custom file in your theme. Any changes you make via the UI Builder will not be saved.', 'fintech-wp' ) . '</p></div>';
    ...
    $ot_register_pages_array =  array( 
      array( 
        'id'              => 'ot',
        'page_title'      => esc_html__( 'OptionTree', 'fintech-wp' ),
        'menu_title'      => esc_html__( 'OptionTree', 'fintech-wp' ),
      ...
      array(
        ...
        'page_title'      => esc_html__( 'Settings', 'fintech-wp' ),
        'menu_title'      => esc_html__( 'Settings', 'fintech-wp' ),
        'capability'      => 'edit_theme_options',
        'menu_slug'       => 'ot-settings',
        'icon_url'        => null,
        'position'        => null,
        'updated_message' => esc_html__( 'Theme Options updated.', 'fintech-wp' ),
        'reset_message'   => esc_html__( 'Theme Options reset.', 'fintech-wp' ),
        'button_text'     => esc_html__( 'Save Settings', 'fintech-wp' ),
        'show_buttons'    => false,
        'sections'        => array(
          array(
            'id'          => 'create_setting',
            'title'       => esc_html__( 'Theme Options UI', 'fintech-wp' )
          ),
          array(
            'id'          => 'import',
            'title'       => esc_html__( 'Import', 'fintech-wp' )
          ),
          array(
            'id'          => 'export',
            'title'       => esc_html__( 'Export', 'fintech-wp' )
          ),
          array(
            'id'          => 'layouts',
            'title'       => esc_html__( 'Layouts', 'fintech-wp' )
          )
        ),
        'settings'        => array(
          array(
            'id'          => 'theme_options_ui_text',
            'label'       => esc_html__( 'Theme Options UI Builder', 'fintech-wp' ),
            'type'        => 'theme_options_ui',
            'section'     => 'create_setting'
          ),
          array(
            'id'          => 'import_xml_text',
            'label'       => esc_html__( 'Settings XML', 'fintech-wp' ),
            'type'        => 'import-xml',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_settings_text',
            'label'       => esc_html__( 'Settings', 'fintech-wp' ),
            'type'        => 'import-settings',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_data_text',
            'label'       => esc_html__( 'Theme Options', 'fintech-wp' ),
            'type'        => 'import-data',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_layouts_text',
            'label'       => esc_html__( 'Layouts', 'fintech-wp' ),
            'type'        => 'import-layouts',
            'section'     => 'import'
          ),
          array(
            'id'          => 'export_settings_file_text',
            'label'       => esc_html__( 'Settings PHP File', 'fintech-wp' ),
          ...
          array(
            ...
            'label'       => esc_html__( 'Layout Management', 'fintech-wp' ),
            'type'        => 'modify-layouts',
            'section'     => 'layouts'
          )
        )
      ...
      array(
        'id'              => 'documentation',
        'parent_slug'     => 'ot-settings',
        'page_title'      => esc_html__( 'Documentation', 'fintech-wp' ),
        'menu_title'      => esc_html__( 'Documentation', 'fintech-wp' ),
        'capability'      => 'edit_theme_options',
        ...
        'sections'        => array(
          array(
            'id'          => 'creating_options',
            'title'       => esc_html__( 'Creating Options', 'fintech-wp' )
          ),
          array(
            'id'          => 'option_types',
            'title'       => esc_html__( 'Option Types', 'fintech-wp' )
          ),
          array(
            'id'          => 'functions',
            'title'       => esc_html__( 'Function References', 'fintech-wp' )
          ),
          array(
            'id'          => 'theme_mode',
            'title'       => esc_html__( 'Theme Mode', 'fintech-wp' )
          ),
          array(
            'id'          => 'meta_boxes',
            'title'       => esc_html__( 'Meta Boxes', 'fintech-wp' )
          ),
          array(
            'id'          => 'examples',
            'title'       => esc_html__( 'Code Examples', 'fintech-wp' )
          ),
          array(
            'id'          => 'layouts_overview',
            'title'       => esc_html__( 'Layouts Overview', 'fintech-wp' )
          )
        ),
        'settings'        => array(
          array(
            'id'          => 'creating_options_text',
            'label'       => esc_html__( 'Overview of available Theme Option fields.', 'fintech-wp' ),
            'type'        => 'creating-options',
            'section'     => 'creating_options'
          ),
          array(
            'id'          => 'option_types_text',
            'label'       => esc_html__( 'Option types in alphabetical order & hooks to filter them.', 'fintech-wp' ),
            'type'        => 'option-types',
            'section'     => 'option_types'
          ),
          array(
            'id'          => 'functions_ot_get_option',
            'label'       => esc_html__( 'Function Reference:ot_get_option()', 'fintech-wp' ),
            'type'        => 'ot-get-option',
            'section'     => 'functions'
          ),
          array(
            'id'          => 'functions_get_option_tree',
            'label'       => esc_html__( 'Function Reference:get_option_tree()', 'fintech-wp' ),
            'type'        => 'get-option-tree',
            'section'     => 'functions'
          ),
          array(
            'id'          => 'theme_mode_text',
            'label'       => esc_html__( 'Theme Mode', 'fintech-wp' ),
            'type'        => 'theme-mode',
            'section'     => 'theme_mode'
          ),
          array(
            'id'          => 'meta_boxes_text',
            'label'       => esc_html__( 'Meta Boxes', 'fintech-wp' ),
            'type'        => 'meta-boxes',
            'section'     => 'meta_boxes'
          ),
          array(
            'id'          => 'example_text',
            'label'       => esc_html__( 'Code examples for front-end development.', 'fintech-wp' ),
            'type'        => 'examples',
            'section'     => 'examples'
          ),
          array(
            'id'          => 'layouts_overview_text',
            'label'       => esc_html__( 'What\'s a layout anyhow?', 'fintech-wp' ),
    ...
    if ( 'background' == $type ) {
      ...
      foreach( $input as $key => $value ) {
        ...
        if ( $key == 'width' && ! empty( $value ) && ! is_numeric( $value ) ) {
          ...
          add_settings_error( 'option-tree', 'invalid_border_width', sprintf( esc_html__( 'The %s input field for %s only allows numeric values.', 'fintech-wp' ), '<code>width</code>', '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( 0 === preg_match( '/^#([a-f0-9]{6}|[a-f0-9]{3})$/i', $input ) && 0 === preg_match( '/^rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9\.]{1,4})\s*\)/i', $input ) ) {
        ...
        add_settings_error( 'option-tree', 'invalid_hex', sprintf( esc_html__( 'The %s Colorpicker only allows valid hexadecimal or rgba values.', 'fintech-wp' ), '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( isset( $errors ) ) {
        ...
        foreach( $errors as $error ) {
          ...
          add_settings_error( 'option-tree', 'invalid_dimension_' . $error, sprintf( esc_html__( 'The %s input field for %s only allows numeric values.', 'fintech-wp' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( isset( $errors ) ) {
        ...
        foreach( $errors as $error ) {
          ...
          add_settings_error( 'option-tree', 'invalid_spacing_' . $error, sprintf( esc_html__( 'The %s input field for %s only allows numeric values.', 'fintech-wp' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
  ...
  function ot_admin_scripts() {
    ...
    $localized_array = array( 
      ...
      'upload_text'           => apply_filters( 'ot_upload_text', esc_html__( 'Send to OptionTree', 'fintech-wp' ) ),
      'remove_media_text'     => esc_html__( 'Remove Media', 'fintech-wp' ),
      'reset_agree'           => esc_html__( 'Are you sure you want to reset back to the defaults?', 'fintech-wp' ),
      'remove_no'             => esc_html__( 'You can\'t remove this! But you can edit the values.', 'fintech-wp' ),
      'remove_agree'          => esc_html__( 'Are you sure you want to remove this?', 'fintech-wp' ),
      'activate_layout_agree' => esc_html__( 'Are you sure you want to activate this layout?', 'fintech-wp' ),
      'setting_limit'         => esc_html__( 'Sorry, you can\'t have settings three levels deep.', 'fintech-wp' ),
      'delete'                => esc_html__( 'Delete Gallery', 'fintech-wp' ), 
      'edit'                  => esc_html__( 'Edit Gallery', 'fintech-wp' ), 
      'create'                => esc_html__( 'Create Gallery', 'fintech-wp' ), 
      'confirm'               => esc_html__( 'Are you sure you want to delete this Gallery?', 'fintech-wp' ),
      'date_current'          => esc_html__( 'Today', 'fintech-wp' ),
      'date_time_current'     => esc_html__( 'Now', 'fintech-wp' ),
      'date_close'            => esc_html__( 'Close', 'fintech-wp' ),
      'replace'               => esc_html__( 'Featured Image', 'fintech-wp' ),
      'with'                  => esc_html__( 'Image', 'fintech-wp' )
    );
...
if ( ! function_exists( 'ot_create_media_post' ) ) {
  ...
  function ot_create_media_post() {
    ...
    $regsiter_post_type( 'option-tree', array(
      'labels'              => array( 'name' => esc_html__( 'Option Tree', 'fintech-wp' ) ),
      'public'              => false,
      'show_ui'             => false,
      ...
      if ( ! isset( $settings['sections'] ) || ! isset( $settings['settings'] ) ) {
        ...
        $settings = array(
          'sections' => array(
            array(
              'id'        => 'general',
              'title'     => esc_html__( 'General', 'fintech-wp' )
            )
          ),
          'settings' => array(
            array(
              'id'        => 'sample_text',
              'label'     => esc_html__( 'Sample Text Field Label', 'fintech-wp' ),
              'desc'      => esc_html__( 'Description for the sample text field.', 'fintech-wp' ),
              'section'   => 'general',
              'type'      => 'text',
              'std'       => '',
              'class'     => '',
  ...
  function ot_alert_message( $page = array() ) {
    ...
    if ( $action == 'save-settings' ) {
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Settings updated.', 'fintech-wp' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Settings could not be saved.', 'fintech-wp' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Settings Imported.', 'fintech-wp' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Settings could not be imported.', 'fintech-wp' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Data Imported.', 'fintech-wp' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Data could not be imported.', 'fintech-wp' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layouts Imported.', 'fintech-wp' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Layouts could not be imported.', 'fintech-wp' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layouts Updated.', 'fintech-wp' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Layouts could not be updated.', 'fintech-wp' ) . '</p></div>';
        
      } else if ( $message == 'deleted' ) {
        
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layouts have been deleted.', 'fintech-wp' ) . '</p></div>';
        
      }
    
    } else if ( $updated == 'layout' ) {  
       
      return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layout activated.', 'fintech-wp' ) . '</p></div>';
...
if ( ! function_exists( 'ot_option_types_array' ) ) {
  ...
  function ot_option_types_array() {
    ...
    return apply_filters( 'ot_option_types_array', array( 
      'background'                => esc_html__('Background', 'fintech-wp'),
      'border'                    => esc_html__('Border', 'fintech-wp'),
      'box-shadow'                => esc_html__('Box Shadow', 'fintech-wp'),
      'category-checkbox'         => esc_html__('Category Checkbox', 'fintech-wp'),
      'category-select'           => esc_html__('Category Select', 'fintech-wp'),
      'checkbox'                  => esc_html__('Checkbox', 'fintech-wp'),
      'colorpicker'               => esc_html__('Colorpicker', 'fintech-wp'),
      'colorpicker-opacity'       => esc_html__('Colorpicker Opacity', 'fintech-wp'),
      'css'                       => esc_html__('CSS', 'fintech-wp'),
      'custom-post-type-checkbox' => esc_html__('Custom Post Type Checkbox', 'fintech-wp'),
      'custom-post-type-select'   => esc_html__('Custom Post Type Select', 'fintech-wp'),
      'date-picker'               => esc_html__('Date Picker', 'fintech-wp'),
      'date-time-picker'          => esc_html__('Date Time Picker', 'fintech-wp'),
      'dimension'                 => esc_html__('Dimension', 'fintech-wp'),
      'gallery'                   => esc_html__('Gallery', 'fintech-wp'),
      'google-fonts'              => esc_html__('Google Fonts', 'fintech-wp'),
      'javascript'                => esc_html__('JavaScript', 'fintech-wp'),
      'link-color'                => esc_html__('Link Color', 'fintech-wp'),
      'list-item'                 => esc_html__('List Item', 'fintech-wp'),
      'measurement'               => esc_html__('Measurement', 'fintech-wp'),
      'numeric-slider'            => esc_html__('Numeric Slider', 'fintech-wp'),
      'on-off'                    => esc_html__('On/Off', 'fintech-wp'),
      'page-checkbox'             => esc_html__('Page Checkbox', 'fintech-wp'),
      'page-select'               => esc_html__('Page Select', 'fintech-wp'),
      'post-checkbox'             => esc_html__('Post Checkbox', 'fintech-wp'),
      'post-select'               => esc_html__('Post Select', 'fintech-wp'),
      'radio'                     => esc_html__('Radio', 'fintech-wp'),
      'radio-image'               => esc_html__('Radio Image', 'fintech-wp'),
      'select'                    => esc_html__('Select', 'fintech-wp'),
      'sidebar-select'            => esc_html__('Sidebar Select',  'fintech-wp'),
      'slider'                    => esc_html__('Slider', 'fintech-wp'),
      'social-links'              => esc_html__('Social Links', 'fintech-wp'),
      'spacing'                   => esc_html__('Spacing', 'fintech-wp'),
      'tab'                       => esc_html__('Tab', 'fintech-wp'),
      'tag-checkbox'              => esc_html__('Tag Checkbox', 'fintech-wp'),
      'tag-select'                => esc_html__('Tag Select', 'fintech-wp'),
      'taxonomy-checkbox'         => esc_html__('Taxonomy Checkbox', 'fintech-wp'),
      'taxonomy-select'           => esc_html__('Taxonomy Select', 'fintech-wp'),
      'text'                      => esc_html__('Text', 'fintech-wp'),
      'textarea'                  => esc_html__('Textarea', 'fintech-wp'),
      'textarea-simple'           => esc_html__('Textarea Simple', 'fintech-wp'),
      'textblock'                 => esc_html__('Textblock', 'fintech-wp'),
      'textblock-titled'          => esc_html__('Textblock Titled', 'fintech-wp'),
      'typography'                => esc_html__('Typography', 'fintech-wp'),
      'upload'                    => esc_html__('Upload', 'fintech-wp')
    ) );
...
if ( ! function_exists( 'ot_radio_images' ) ) {
  ...
  function ot_radio_images( $field_id = '' ) {
    ...
    return apply_filters( 'ot_radio_images', array(
      array(
        'value'   => 'left-sidebar',
        'label'   => esc_html__( 'Left Sidebar', 'fintech-wp' ),
        'src'     => OT_URL . 'assets/images/layout/left-sidebar.png'
      ),
      array(
        'value'   => 'right-sidebar',
        'label'   => esc_html__( 'Right Sidebar', 'fintech-wp' ),
        'src'     => OT_URL . 'assets/images/layout/right-sidebar.png'
      ),
      array(
        'value'   => 'full-width',
        'label'   => esc_html__( 'Full Width (no sidebar)', 'fintech-wp' ),
...
if ( ! function_exists( 'ot_list_item_settings' ) ) {
  ...
  function ot_list_item_settings( $id ) {
    ...
    $settings = apply_filters( 'ot_list_item_settings', array(
      array(
        'id'        => 'image',
        'label'     => esc_html__( 'Image', 'fintech-wp' ),
        'desc'      => '',
        'std'       => '',
        'type'      => 'upload',
        'rows'      => '',
      ...
      array(
        'id'        => 'link',
        'label'     => esc_html__( 'Link', 'fintech-wp' ),
        'desc'      => '',
        'std'       => '',
        'type'      => 'text',
        'rows'      => '',
      ...
      array(
        'id'        => 'description',
        'label'     => esc_html__( 'Description', 'fintech-wp' ),
        'desc'      => '',
        'std'       => '',
  ...
  function ot_social_links_settings( $id ) {
    ...
    $settings = apply_filters( 'ot_social_links_settings', array(
      array(
        ...
        'desc'      => esc_html__( 'Enter the name of the social website.', 'fintech-wp' ),
        'std'       => '',
        'type'      => 'text',
      ...
      array(
        'id'        => 'title',
        'label'     => 'Title',
        'desc'      => esc_html__( 'Enter the text shown in the title attribute of the link.', 'fintech-wp' ),
        'type'      => 'text'
      ),
      array(
        'id'        => 'href',
        'label'     => 'Link',
        'desc'      => sprintf( esc_html__( 'Enter a link to the profile or page on the social website. Remember to add the %s part to the front of the link.', 'fintech-wp' ), '<code>http://</code>' ),
        'type'      => 'text',
      )
    ), $id );
  ...
  function ot_insert_css_with_markers( $field_id = '', $insertion = '', $meta = false ) {
    ...
    if ( file_exists( $filepath ) ) {
      ...
      if ( ! is_writable( $filepath ) ) {
        add_settings_error( 'option-tree', 'dynamic_css', sprintf( esc_html__( 'Unable to write to file %s.', 'fintech-wp' ), '<code>' . $filepath . '</code>' ), 'error' );
        return false;
      }
  ...
  function ot_sections_view( $name, $key, $section = array() ) {
    ...
    <div class="option-tree-setting is-section">
      ...
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-setting-edit option-tree-ui-button button left-item" title="' . esc_html__( 'edit', 'fintech-wp' ) . '">
          <span class="icon ot-icon-pencil"></span>' . esc_html__( 'Edit', 'fintech-wp' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="' . esc_html__( 'Delete', 'fintech-wp' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . esc_html__( 'Delete', 'fintech-wp' ) . '
        </a>
      </div>
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . esc_html__( 'Section Title: Displayed as a menu item on the Theme Options page.', 'fintech-wp' ) . '</div>
        ...
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . esc_html__( 'Section ID: A unique lower case alphanumeric string, underscores allowed.', 'fintech-wp' ) . '</div>
            <div class="format-setting-inner">
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'Label: Displayed as the label of a form element on the Theme Options page.', 'fintech-wp' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'ID: A unique lower case alphanumeric string, underscores allowed.', 'fintech-wp' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-select wide-desc">
            <div class="description">' . esc_html__( 'Type: Choose one of the available option types from the dropdown.', 'fintech-wp' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textarea wide-desc">
            <div class="description">' . esc_html__( 'Description: Enter a detailed description for the users to read on the Theme Options page, HTML is allowed. This is also where you enter content for both the Textblock & Textblock Titled option types.', 'fintech-wp' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textblock wide-desc">
            <div class="description">' . esc_html__( 'Choices: This will only affect the following option types: Checkbox, Radio, Select & Select Image.', 'fintech-wp' ) . '</div>
            <div class="format-setting-inner">
              ...
              <a href="javascript:void(0);" class="option-tree-choice-add option-tree-ui-button button hug-left">' . esc_html__( 'Add Choice', 'fintech-wp' ) . '</a>
            </div>
          </div>
        </div>
        <div class="format-settings">
          <div class="format-setting type-textblock wide-desc">
            <div class="description">' . esc_html__( 'Settings: This will only affect the List Item option type.', 'fintech-wp' ) . '</div>
            <div class="format-setting-inner">
              <ul class="option-tree-setting-wrap option-tree-sortable" data-name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . ']">
                ' . ( isset( $setting['settings'] ) ? ot_loop_through_sub_settings( $name . '[' . $key . '][settings]', $setting['settings'] ) : '' ) . '
              </ul>
              <a href="javascript:void(0);" class="option-tree-list-item-setting-add option-tree-ui-button button hug-left">' . esc_html__( 'Add Setting', 'fintech-wp' ) . '</a>
            </div>
          </div>
        </div>
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'Standard: Setting the standard value for your option only works for some option types. Read the OptionTree->Documentation for more information on which ones.', 'fintech-wp' ) . '</div>
            <div class="format-setting-inner">
              ' . $std_form_element . '
            </div>
          </div>
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'Rows: Enter a numeric value for the number of rows in your textarea. This will only affect the following option types: CSS, Textarea, & Textarea Simple.', 'fintech-wp' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'Post Type: Add a comma separated list of post type like \'post,page\'. This will only affect the following option types: Custom Post Type Checkbox, & Custom Post Type Select.', 'fintech-wp' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'Taxonomy: Add a comma separated list of any registered taxonomy like \'category,post_tag\'. This will only affect the following option types: Taxonomy Checkbox, & Taxonomy Select.', 'fintech-wp' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'Min, Max, & Step: Add a comma separated list of options in the following format 0,100,1 (slide from 0-100 in intervals of 1). The three values represent the minimum, maximum, and step options and will only affect the Numeric Slider option type.', 'fintech-wp' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'CSS Class: Add and optional class to this option type.', 'fintech-wp' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-select wide-desc">
            <div class="description">' . esc_html__( 'Operator: Choose the logical operator to compute the result of the conditions.', 'fintech-wp' ) . '</div>
            <div class="format-setting-inner">
              <select name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . '][operator]" value="' . $operator . '" class="option-tree-ui-select">
                <option value="and" ' . selected( $operator, 'and', false ) . '>' . esc_html__( 'and', 'fintech-wp' ) . '</option>
                <option value="or" ' . selected( $operator, 'or', false ) . '>' . esc_html__( 'or', 'fintech-wp' ) . '</option>
              </select>
            </div>
          </div>
        </div>
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting-label">
            <h5>' . esc_html__( 'Label', 'fintech-wp' ) . '</h5>
          </div>
          <div class="format-setting type-text wide-desc">
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting-label">
            <h5>' . esc_html__( 'Value', 'fintech-wp' ) . '</h5>
          </div>
          <div class="format-setting type-text wide-desc">
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting-label">
            <h5>' . esc_html__( 'Image Source (Radio Image only)', 'fintech-wp' ) . '</h5>
          </div>
          <div class="format-setting type-text wide-desc">
            <div class="format-setting-inner">
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text no-desc">
            <div class="description">' . esc_html__( 'Title: Displayed as a contextual help menu item on the Theme Options page.', 'fintech-wp' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textarea no-desc">
            <div class="description">' . esc_html__( 'Content: Enter the HTML content about this contextual help item displayed on the Theme Option page for end users to read.', 'fintech-wp' ) . '</div>
            <div class="format-setting-inner">
...
if ( ! function_exists( 'ot_layout_view' ) ) {
  ...
  function ot_layout_view( $key, $data = '', $active_layout = '' ) {
    ...
    return '
    <div class="option-tree-setting">
      <div class="open">' . ( isset( $key ) ? esc_attr( $key ) : esc_html__( 'Layout', 'fintech-wp' ) ) . '</div>
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-layout-activate option-tree-ui-button button left-item' . ( $active_layout == $key ? ' active' : '' ) . '" title="' . esc_html__( 'Activate', 'fintech-wp' ) . '">
          <span class="icon ot-icon-square-o"></span>' . esc_html__( 'Activate', 'fintech-wp' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="'. esc_html__( 'Delete', 'fintech-wp' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . esc_html__( 'Delete', 'fintech-wp' ) . '
        </a>
...
if ( ! function_exists( 'ot_list_item_view' ) ) {
  ...
  function ot_list_item_view( $name, $key, $list_item = array(), $post_id = 0, $get_option = '', $settings = array(), $type = '' ) {
    ...
    $required_setting = array(
      array(
        'id'        => 'title',
        'label'     => esc_html__( 'Title', 'fintech-wp' ),
        'desc'      => '',
        'std'       => '',
        'type'      => 'text',
        'rows'      => '',
  ...
  function ot_theme_options_layouts_form( $active = false ) {
    ...
    echo '<form method="post" id="option-tree-options-layouts-form">';
      ...
      echo '<div class="option-tree-save-layout' . ( ! empty( $active_layout ) ? ' active-layout' : '' ) . '">';
        ...
        echo '<button type="submit" class="option-tree-ui-button button button-primary save-layout" title="' . esc_html__( 'New Layout', 'fintech-wp' ) . '">' . esc_html__( 'New Layout', 'fintech-wp' ) . '</button>';
...
function ot_meta_box_post_format_gallery( $pages = 'post' ) {
  ...
  return apply_filters( 'ot_meta_box_post_format_gallery', array(
    ...
    'title'     => esc_html__( 'Gallery', 'fintech-wp' ),
    'desc'      => '',
    'pages'     => $pages,
    'context'   => 'side',
    'priority'  => 'low',
...
function ot_meta_box_post_format_link( $pages = 'post' ) {
  ...
  return apply_filters( 'ot_meta_box_post_format_link', array(
    ...
    'title'     => esc_html__( 'Link', 'fintech-wp' ),
    'desc'      => '',
    'pages'     => $pages,
    'context'   => 'side',
    'priority'  => 'low',
    'fields'    => array(
      array(
        'id'      => '_format_link_url',
        'label'   => '',
        'desc'    => esc_html__( 'Link URL', 'fintech-wp' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Link Title', 'fintech-wp' ),
        'std'     => '',
        'type'    => 'text'
      )
  	)
...
function ot_meta_box_post_format_quote( $pages = 'post' ) {
  ...
  return apply_filters( 'ot_meta_box_post_format_quote', array(
    ...
    'title'     => esc_html__( 'Quote', 'fintech-wp' ),
    'desc'      => '',
    'pages'     => $pages,
    'context'   => 'side',
    'priority'  => 'low',
    'fields'    => array(
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source Name (ex. author, singer, actor)', 'fintech-wp' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source URL', 'fintech-wp' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source Title (ex. book, song, movie)', 'fintech-wp' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source Date', 'fintech-wp' ),
        'std'     => '',
        'type'    => 'text'
      )
  	)
...
function ot_meta_box_post_format_video( $pages = 'post' ) {
  ...
  return apply_filters( 'ot_meta_box_post_format_video', array(
    ...
    'title'     => esc_html__( 'Video', 'fintech-wp' ),
    'desc'      => '',
    'pages'     => $pages,
    'context'   => 'side',
    'priority'  => 'low',
    'fields'    => array(
      array(
        ...
        'label'   => '',
        'desc'    => sprintf( esc_html__( 'Embed video from services like Youtube, Vimeo, or Hulu. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'fintech-wp' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . esc_html__( 'Wordpress Codex', 'fintech-wp' ) .'</a>', '<code>[video]</code>' ),
        'std'     => '',
        'type'    => 'textarea'
      )
  	)
...
function ot_meta_box_post_format_audio( $pages = 'post' ) {
  ...
  return apply_filters( 'ot_meta_box_post_format_audio', array(
    ...
    'title'     => esc_html__( 'Audio', 'fintech-wp' ),
    'desc'      => '',
    'pages'     => $pages,
    'context'   => 'side',
    'priority'  => 'low',
